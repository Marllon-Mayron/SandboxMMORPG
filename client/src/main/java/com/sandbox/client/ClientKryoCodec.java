...
public class ClientKryoCodec extends ByteToMessageCodec<Object> {
    private static final Logger logger = LoggerFactory.getLogger(ClientKryoCodec.class);
    private final Kryo kryo;

    public ClientKryoCodec() {
        this.kryo = new Kryo();
        KryoRegistry.registerClasses(kryo);
        logger.info("ClientKryoCodec initialized with unified registry");
    }
